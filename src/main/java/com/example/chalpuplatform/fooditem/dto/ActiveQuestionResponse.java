...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "활성화된 질문 응답")
public class ActiveQuestionResponse {
    ...
    public static ActiveQuestionResponse from(SurveyQuestion question) {
        return ActiveQuestionResponse.builder()
